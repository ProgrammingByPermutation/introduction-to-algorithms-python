...
class TestRedBlackTree(TestCase):
    ...
    def test_rotate(self):
        tree = RedBlackTree()
        tree.root = RedBlackTree.TreeNode(7)
        tree.root.p = tree.sentinel
        tree.root.left = RedBlackTree.TreeNode(4)
        tree.root.left.left = RedBlackTree.TreeNode(3)
        tree.root.left.right = RedBlackTree.TreeNode(6)
        tree.root.left.left.left = RedBlackTree.TreeNode(2)
        tree.root.right = RedBlackTree.TreeNode(11)
        tree.root.right.left = RedBlackTree.TreeNode(9)
        tree.root.right.right = RedBlackTree.TreeNode(18)
        tree.root.right.right.left = RedBlackTree.TreeNode(14)
        tree.root.right.right.left.left = RedBlackTree.TreeNode(12)
        tree.root.right.right.left.right = RedBlackTree.TreeNode(17)
        tree.root.right.right.right = RedBlackTree.TreeNode(19)
        tree.root.right.right.right.right = RedBlackTree.TreeNode(22)
        tree.root.right.right.right.left = RedBlackTree.TreeNode(20)
...
class TestOrderStatisticTree(TestCase):
    def test_all(self):
        ...
        # There are two 14s and two 21s, we don't bother checking both
        self.assertEqual(tree.tree_search(tree.root, 26).size, 20)
        self.assertEqual(tree.tree_search(tree.root, 17).size, 12)
        self.assertEqual(tree.tree_search(tree.root, 41).size, 7)
        self.assertEqual(tree.tree_search(tree.root, 14).size, 7)
        self.assertEqual(tree.tree_search(tree.root, 21).size, 4)
        self.assertEqual(tree.tree_search(tree.root, 30).size, 5)
        self.assertEqual(tree.tree_search(tree.root, 47).size, 1)
        self.assertEqual(tree.tree_search(tree.root, 10).size, 4)
        self.assertEqual(tree.tree_search(tree.root, 16).size, 2)
        self.assertEqual(tree.tree_search(tree.root, 19).size, 2)
        self.assertEqual(tree.tree_search(tree.root, 28).size, 1)
        self.assertEqual(tree.tree_search(tree.root, 38).size, 3)
        self.assertEqual(tree.tree_search(tree.root, 7).size, 2)
        self.assertEqual(tree.tree_search(tree.root, 12).size, 1)
        self.assertEqual(tree.tree_search(tree.root, 20).size, 1)
        self.assertEqual(tree.tree_search(tree.root, 35).size, 1)
        self.assertEqual(tree.tree_search(tree.root, 39).size, 1)
        self.assertEqual(tree.tree_search(tree.root, 3).size, 1)

        self.assertEqual(tree.os_select(tree.root, 17).key, 38)

        self.assertEqual(tree.os_rank(tree.tree_search(tree.root, 38)), 17)

        tree.rb_delete(tree.tree_search(tree.root, 39))

        self.assertEqual(tree.tree_search(tree.root, 26).size, 19)
        self.assertEqual(tree.tree_search(tree.root, 17).size, 12)
        self.assertEqual(tree.tree_search(tree.root, 41).size, 6)
        self.assertEqual(tree.tree_search(tree.root, 14).size, 7)
        self.assertEqual(tree.tree_search(tree.root, 21).size, 4)
        self.assertEqual(tree.tree_search(tree.root, 30).size, 4)
        self.assertEqual(tree.tree_search(tree.root, 47).size, 1)
        self.assertEqual(tree.tree_search(tree.root, 10).size, 4)
        self.assertEqual(tree.tree_search(tree.root, 16).size, 2)
        self.assertEqual(tree.tree_search(tree.root, 19).size, 2)
        self.assertEqual(tree.tree_search(tree.root, 28).size, 1)
        self.assertEqual(tree.tree_search(tree.root, 38).size, 2)
        self.assertEqual(tree.tree_search(tree.root, 7).size, 2)
        self.assertEqual(tree.tree_search(tree.root, 12).size, 1)
        self.assertEqual(tree.tree_search(tree.root, 20).size, 1)
        self.assertEqual(tree.tree_search(tree.root, 35).size, 1)
